...
/*
*表单提交
*@param mix a / a.u 地址  a.a 参数  a.t 表单目标iframe的容器  a.b 提交按钮  a.f 成功时callback
*/
doPost:function(a){
if(!this.doPostForm){
...
/*
 *综合调用
 *@param attrName , attrValue 设置属性
 *@param event , callback 注册事件
 *@param domNode/null  增加子节点 null参数会被跳过 (有nodeType属性的object视为domNode)
